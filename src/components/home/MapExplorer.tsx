              ...
              >
                <div className="flex flex-col gap-5 lg:col-span-7">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="font-display text-[clamp(22px,2.4vw,30px)] font-medium leading-snug text-teal-deep">
                      {s.leak}
                    </p>
                  </div>
                  <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col justify-center gap-3.5 rounded-[18px] bg-teal-deep p-7 text-paper md:p-9 lg:col-span-5">
                  {s.stat ? (
                    <>
                      <p className="font-display text-[clamp(48px,6vw,64px)] font-medium leading-none text-clay-soft">
                        {s.stat.value}
                      </p>
