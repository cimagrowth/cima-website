...
const PositioningBand = () => {
  return (
    <section
      id="positioning"
      className="bg-teal text-paper py-14 md:py-20"
    >
      <div className="max-w-4xl mx-auto px-6 text-center">
        <p className="font-display font-[340] tracking-tight text-[clamp(22px,2.6vw,34px)] leading-snug">
