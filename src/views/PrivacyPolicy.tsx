    ...
    <>
      <div className="container-wide px-4 md:px-6 py-12 md:py-20 max-w-4xl mx-auto">
        <article className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <ol>
            <li><strong>Will only use access</strong> to Google Calendar events, Google Analytics reports, Google Business Profile reviews and questions, Google Tag Manager container listings, and Google Ads campaign and conversion data, to provide or improve user-facing features that are prominent in the GrowthOS user interface: consultation scheduling, analytics dashboards and reports, drafting and publishing replies, answers and posts on your Google Business Profile, container selection for the landing pages we host for you, and advertising campaign management and measurement.</li>
