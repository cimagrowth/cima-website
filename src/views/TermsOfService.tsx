    ...
    <>
      <div className="container-wide px-4 md:px-6 py-12 md:py-20 max-w-4xl mx-auto">
        <article className="prose prose-lg dark:prose-invert max-w-none">
          <h1 className="font-display text-3xl md:text-4xl font-[340] tracking-tight mb-2">Terms of Service and Master Services Agreement</h1>
          ...
          <p>This Agreement constitutes a legally binding contract between the parties.</p>
          ...
          <h2>4. Modification of Agreement</h2>
          <p>
          ...
          <h2>5. Services; No Guarantee of Availability</h2>
          <p>
          ...
          <h2>6. GrowthOS Advertising Management Services</h2>
          <p>
          ...
          <h2>8. Fees, Billing, and Utilization Charges</h2>
          <p>
          ...
          <div className="overflow-x-auto">
            <table>
              <tbody>
                <tr><td>SMS</td><td>$0.0083 per segment</td></tr>
                <tr><td>Email</td><td>$0.000709 per message</td></tr>
                <tr><td>Outbound Calls</td><td>$0.0147 per minute</td></tr>
                <tr><td>Inbound Calls</td><td>$0.0084 per minute</td></tr>
                <tr><td>Local Number</td><td>$3.00 per month</td></tr>
                <tr><td>Toll-Free Number</td><td>$5.00 per month</td></tr>
                <tr><td>AI Content Generation</td><td>$0.09 per 1,000 words</td></tr>
                <tr><td>AI Funnel Generation</td><td>$1.05 per funnel</td></tr>
              </tbody>
            </table>
          </div>
          <p>Client authorizes automatic billing for all applicable charges.</p>

          <h2>9. Term, Renewal, and Termination</h2>
          <p>
          ...
          <h2>13. HIPAA Business Associate Agreement</h2>
          <p>
          ...
          <p>This section constitutes a Business Associate Agreement for HIPAA purposes.</p>

          <h2>14. Service Levels and Availability</h2>
          <h3>14.1 Service Availability</h3>
          <p>
          ...
          <h3>14.2 Permitted Downtime</h3>
          <p>The following shall not be included in uptime calculations and shall not constitute a breach of this Agreement:</p>
          <ul>
            <li>Scheduled maintenance, updates, upgrades, or repairs, including emergency maintenance, whether or not advance notice is provided;</li>
            <li>Downtime caused by failures of the internet, telecommunications networks, hosting providers, cloud infrastructure providers, or utilities outside Company's reasonable control;</li>
            <li>Downtime resulting from acts or omissions of Client, its users, agents, contractors, or third-party integrations authorized by Client;</li>
            <li>Downtime caused by third-party platforms or services, including but not limited to Advertising Platforms, payment processors, email providers, SMS carriers, voice providers, or AI model providers;</li>
            <li>Force majeure events, including acts of God, natural disasters, war, terrorism, labor disputes, governmental actions, or widespread service outages.</li>
          </ul>

          <h3>14.3 No Guaranteed Performance Levels</h3>
          <p>
          ...
          <h3>14.5 No SLA for Advertising or Third-Party Services</h3>
          <p>Client expressly acknowledges that:</p>
          <ul>
            <li>Advertising Platforms, AI model providers, carriers, and other third-party services operate independently of Company;</li>
            <li>Company makes no service level commitments regarding advertising delivery, approvals, lead flow, message delivery, call connectivity, AI response times, or third-party service availability;</li>
            <li>Any outages, suspensions, delays, or failures caused by third-party services shall not constitute a breach of this Agreement.</li>
          </ul>

          <h3>14.6 Suspension for Misuse or Risk</h3>
          <p>
          ...
          <h2>15. Regulatory Compliance Disclaimer</h2>
          <p>
          ...
          <h2>20. Checkout and Execution</h2>
          <p>
