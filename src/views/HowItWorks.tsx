...
const HowItWorksPage = () => {
  const comparisonRows = [
    ...
    { metric: "Cost per campaign", before: "$5,000+ (agency)", after: "Generated by AI in minutes" },
    { metric: "Outreach cost per prospect", before: "$50+ (SDR hire)", after: "Usage-based (AI enrichment)" },
