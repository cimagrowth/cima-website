...
// Static, brand-accurate social card for /growth (Patient Leakage Audit).
// File-convention route -> Next.js auto-injects og:image + twitter:image.
export const runtime = 'edge';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';
export const alt = 'Patient Leakage Audit | Cima Growth Solutions';
...
const TITLE = 'Your clinic is losing patients you already paid for.';
const SUB = 'A free audit of where leads fall out of your funnel. Results in 48 hours.';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Leak-drip accent: a funnel narrowing to a single falling drop */}
        <div
          style={{
            position: 'absolute',
            left: '-90px',
            ...
            height: '340px',
            borderRadius: '9999px',
            backgroundColor: 'rgba(210, 105, 59, 0.16)',
            display: 'flex',
          }}
        />
